...
PASSTHROUGH_OPTIONAL_ENV_VARS = os.getenv(
    "MINIWDL__PASSTHROUGH__ENVVARS",
    "AWS_DEFAULT_REGION,DEPLOYMENT_ENVIRONMENT,AWS_CONTAINER_CREDENTIALS_RELATIVE_URI,AUTH0_CONFIG_SECRET_NAME,ASPEN_CONFIG_SECRET_NAME,REMOTE_DEV_PREFIX").split(",")
